...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Общее «Ул» при своём типе имени уходит (владелец 25.09: иначе
        # вердикт сверял «улица» с «линия» карты).
        ("Ул 8линия дом 11", "8 линия", "11"),
...
def test_имя_деревни_строчными_после_полного_слова_типа() -> None:
    ...
    # общее «Улица» перед ним уходит (владелец 25.09).
